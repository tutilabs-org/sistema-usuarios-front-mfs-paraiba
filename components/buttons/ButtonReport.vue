<template>
  ...
  <section @click="replace">
    <div id="up" :style="{ background: systemColor }">
      <div id="ellipse">
      </div>
    </div>
    <div id="down">
    ...
    replace() {
      switch (this.comReport) {
        ...
        case "REL. TRYOUT":
          ...
          break
        case "MATRIZ DE VERSATILIDADE":
          // alert("Em desenvolvimento")
          window.location.replace(process.env.NUXT_ENV_URL_MATRIZ);
          break
      }
    }
  },
  computed: {
    ...
    systemColor() {
      ...
      switch (this.comReport) {
        ...
        case 'TRYOUT':
          return 'var(--soltryout-color)';
        case 'REL. TRYOUT':
          return 'var(--reltryout-color)';
        case 'FIT':
          return 'var(--fit-color)';
        case 'FTI':
          return 'var(--fti-color)';
        case 'MATRIZ DE VERSATILIDADE':
